...
function run () {
  ...
  const logsCommand = cliparse.command('logs', {
    ...
    options: [opts.alias, opts.appIdOrName, opts.orgaIdOrName, opts.before, opts.after, opts.search, opts.deploymentId, opts.addonId, opts.logsFormat],
  }, logs('appLogs'));
  ...
  const scaleCommand = cliparse.command('scale', {
    ...
    options: [opts.alias, opts.appIdOrName, opts.orgaIdOrName, opts.flavor, opts.minFlavor, opts.maxFlavor, opts.instances, opts.minInstances, opts.maxInstances, opts.buildFlavor],
  }, scale('scale'));
  ...
  const serviceCommands = cliparse.command('service', {
    ...
    options: [opts.alias, opts.appIdOrName, opts.orgaIdOrName, opts.onlyApps, opts.onlyAddons, opts.showAll],
  ...
  const sshCommand = cliparse.command('ssh', {
    ...
    options: [opts.alias, opts.appIdOrName, opts.orgaIdOrName, opts.sshIdentityFile],
  }, ssh('ssh'));
